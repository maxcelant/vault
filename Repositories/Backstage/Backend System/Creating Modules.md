- A [[Repositories/Backstage/Backend System/Modules|Module]] is able to extend a plugin with additional functionality using the [[Extension Points]] registered by the plugin.
