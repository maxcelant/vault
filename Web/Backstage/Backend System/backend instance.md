...
- You can add any feature to a backend instance using `.add()`. Features include: [[plugins]], [[Web/Backstage/Backend System/modules]], or [[service factory|service factories]].
